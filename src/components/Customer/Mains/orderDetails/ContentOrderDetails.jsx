...
const ContentOrderDetails = ({order}) => {
    ...
    const { fullname, deleveryAddress, phoneNumber, orderNotes, cart, createdAt } = order;
        ...
        <div className="container">
            <div className="row orderDetails ">
                <div className="col-lg-12 center" >
                    ...
                    <Accordion style={{borderRadius: "5px"}} square expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
                        <AccordionSummary style={{backgroundColor: "rgba(0, 0, 0, .02)"}} aria-controls="panel1d-content" id="panel1d-header">
                            <Typography style={{fontSize: "1.5rem", color: "#758a53", fontWeight: "500"}}>Your Bill </Typography>
                        </AccordionSummary>
                        <AccordionDetails>
